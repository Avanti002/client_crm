          ...
          children: [
            Card(
              ...
              shape: RoundedRectangleBorder(
                ...
                side: BorderSide(
                    color: Color.fromARGB(255, 70, 49, 41), width: 2.0),
              ),
              child: TableCalendar(
                ...
                headerStyle: const HeaderStyle(
                  ...
                  formatButtonTextStyle: TextStyle(
                      color: Color.fromARGB(255, 168, 28, 18), fontSize: 16.0),
                ...
                daysOfWeekStyle: const DaysOfWeekStyle(
                  ...
                  weekendStyle:
                      TextStyle(color: Color.fromARGB(255, 168, 22, 18)),
                ),
                ...
                calendarStyle: const CalendarStyle(
                  ...
                  todayDecoration: BoxDecoration(
                    color: Color.fromARGB(255, 83, 143, 223),
                  ...
                  markerDecoration: BoxDecoration(
                      color: Color.fromARGB(255, 168, 22, 18),
                      shape: BoxShape.circle),
                ),
