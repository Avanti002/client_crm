...
Future<List<Data>> fetchLeadind() async {
  ...
  var httpsUri = Uri(
      ...
      path: '/api/resource/Lead/${lead.leadind}');
...
Future<List<Data>> updateLead() async {
  ...
  var request = http.Request(
      'PUT',
      Uri.parse(
          'https://demo.erpdata.in/api/resource/Lead/${lead.leadind}?status=$lead_status'));
...
abstract class _UpdateLead extends State<UpdateLead> implements AutoReloader {}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(title: const Text("Update Lead"), actions: <Widget>[
          Padding(
        ...
        body: Padding(
          ...
          child: Column(children: <Widget>[
            ...
            TextFormField(
                ...
                decoration: const InputDecoration(
                    labelText: 'First Name', icon: Icon(Icons.account_circle)),
                onChanged: (value) {},
                validator: (value) {
                  if (value!.isEmpty) {
                    return 'Please enter some text';
            ...
            TextFormField(
              ...
              // onSaved: (val) => _cardDetails.cardHolderName = val,
              decoration: const InputDecoration(
                  labelText: 'Lead Owner', icon: Icon(Icons.account_circle)),
              // onChanged: (value) {
              //   setState(() {
              //     leadowner = value;
              //   });
